...
WIKI_FILE = "./rsc/datasets/topiOCQA/downloads/data/wikipedia_split/full_wiki_segments.tsv"
OUTPUT_FILE = "./outputs/bm25_collection/full_wiki_segments_pyserini_format.jsonl"
